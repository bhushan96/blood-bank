...
<section id="login">
    <div class="container">
    	<div class="row">
    	    <div class="col-md-12">
        	    <div class="form-wrap">
                <h1>Check for the blood availability</h1>
                    <form role="form" action="search" method="post" id="login-form" autocomplete="off" modelAttribute="avail">
                        ...
                        <input type="submit" id="search" class="btn btn-custom btn-lg btn-block" value="Search">
                    </form>
